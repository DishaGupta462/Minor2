...
im = Image.open(r"C:\Users\Disha Gupta\Documents\Sem 6\Crypto Project\Homomorphic-Image-Encryption\test-images\Encrypt.jpg") 
im.show()
img = Image.open(r"C:\Users\Disha Gupta\Documents\Sem 6\Crypto Project\Homomorphic-Image-Encryption\test-images\Decrypt.jpg") 
img.show()
